  ...
  return (
    <section>
      ...
      <div className="container-rec">
        <div className="container-title">Arc De Triomphe</div>
        <div className="container-rec2">
          <img className="image-p" src={Arc} alt="Eiffel Tower" />
          ...
          <div className="reviews">
            ...
            <div className="stars">
              ...
              <FaStar />
              <FaStarHalf />
              <div className="numberofreviews">35 reviews</div>
            </div>
          </div>
