  ...
  return (
    <section>
      ...
      <div className="container-rec">
        <div className="container-title">Louvre Museum</div>
        <div className="container-rec2">
          <img className="image-p" src={Louvre} alt="Eiffel Tower" />
          ...
          <div className="reviews">
            ...
            <div className="stars">
              ...
              <FaStar />
              <FaStar />
              <div className="numberofreviews">20 reviews</div>
            </div>
          </div>
