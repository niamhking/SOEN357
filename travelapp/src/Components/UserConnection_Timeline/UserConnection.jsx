...
<div className="container">
         <div class="row">
              ...
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    ...
                    <p class="card-text">Accommodation: Hotels <br></br> Budget:$3000<br></br> Duration: 8days<br></br></p>
          ...
          <p className='join'>*Click on a trip to know more<br></br><b>Joining information:</b> To join this trip, send a message to the trip planner or click the "Join Trip" button within the app.</p>
